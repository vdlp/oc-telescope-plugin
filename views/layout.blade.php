<?php $helper = new \Vdlp\Telescope\Classes\PathHelper; ?><!DOCTYPE html>
<html lang="en">
<head>
    <!-- Meta Information -->
    <meta charset="utf-8">
    ...
    <link rel="shortcut icon" href="{{ $helper->getAssetsUrlPath('/favicon.ico') }}">
    ...
    <link href="{!! $helper->getAssetsUrlPath($cssFile) !!}" rel="stylesheet" type="text/css">
</head>
<body>
